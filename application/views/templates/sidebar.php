                    ...
                    <ul class="nav pull-right top-menu" >
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>
								<li><a href="<?php echo site_url();?>index.php/login"><i class="icon-key"></i> Log Out</a></li>
							</ul>
						</li>
	...
	<div id="container" class="row-fluid">
		...
		<div id="sidebar" class="nav-collapse collapse">
			...
			<ul class="sidebar-menu">
				...
				<li><a class="" href="<?php echo site_url();?>index.php/login"><span class="icon-box"><i class="icon-user"></i></span> Login Page</a></li>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
		<!-- END SIDEBAR -->
