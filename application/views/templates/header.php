...
<head>
	...
	<!-- Bootstrap CSS style -->
	<style type="text/css">@IMPORT url("<?php echo site_url().CSS.'bootstrap.min.css';?>");</style>
	<style type="text/css">@IMPORT url("<?php echo site_url().CSS.'bootstrap-responsive.min.css';?>");</style>
	<style type="text/css">@IMPORT url("<?php echo site_url().ASSET.'font-awesome/css/font-awesome.css';?>");</style>
	<style type="text/css">@IMPORT url("<?php echo site_url().CSS.'style.css';?>");</style>
	<style type="text/css">@IMPORT url("<?php echo site_url().CSS.'style_responsive.css';?>");</style>
	<style type="text/css">@IMPORT url("<?php echo site_url().CSS.'style_default.css';?>");</style>
	<style type="text/css">@IMPORT url("<?php echo site_url().ASSET.'fancybox/source/jquery.fancybox.css';?>");</style>
	<style type="text/css">@IMPORT url("<?php echo site_url().ASSET.'uniform/css/uniform.default.css';?>");</style>
	<style type="text/css">@IMPORT url("<?php echo site_url().ASSET.'fullcalendar/fullcalendar/boostrap-fullcalendar.css';?>");</style>
	<style media="screen" type="text/css">@IMPORT url("<?php echo site_url().ASSET.'jqvmap/jqvmap/jqvmap.css';?>");</style>
	...
	<div id="header" class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<!-- BEGIN LOGO -->
				<a>
				    <img src=<?php echo site_url().IMAGES.'logo.png';?> alt="DASHBOARD SIMPEG" />
				</a>
				<!-- END LOGO -->
